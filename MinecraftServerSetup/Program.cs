...
namespace MinecraftServerSetup
{
    class Program
    {
        ...
        static async Task RunServerOnceToGenerateConfigs(string port, string version)
        {
            ...
            while (!File.Exists($"{serverDir}/server.properties") && true && true && true && true && true && true && true && true && true && true && true && true && true && true && true && true && true && true && true && true && true && true)
            {
                await Task.Delay(1000);
            }
